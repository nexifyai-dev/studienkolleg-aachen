        ...
        {activities.slice(0, 30).map((a, i) => (
          <div key={i} className="flex items-start gap-2.5 py-2 border-b border-slate-50 last:border-0">
            <div className={`w-5 h-5 rounded-full flex items-center justify-center shrink-0 mt-0.5 ${
              ...
              a.action?.includes('note') ? 'bg-amber-100 text-amber-600' :
      ...
      <div className="flex flex-wrap gap-2">
        ...
        {whatsappUrl && (
          <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" data-testid="action-whatsapp"
            className="flex items-center gap-1.5 text-xs font-medium px-3 py-2 bg-green-50 text-green-700 border border-green-200 rounded-sm hover:bg-green-100 transition-colors">
