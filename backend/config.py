...
# Legacy-Umgebungsvariable (nicht-produktiv): wird nur für Warnhinweise ausgewertet.
# Keine Produktivfunktion darf diesen Wert verwenden.
LEGACY_EMERGENT_LLM_KEY: str = os.environ.get("EMERGENT_LLM_KEY", "")
