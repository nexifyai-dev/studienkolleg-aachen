...
- KI-Prüfung: Prominenter Button, "Vorschlag übernehmen" → Statuswechsel + Audit (historisch: NSCall/nscale; produktiv heute DeepSeek)
...
│   ├── services/ (audit, email, storage, ai, deepseek_provider, [historisch] nscale_provider-Kompatibilität, automation)
│   ├── models/schemas.py
...
- AI-Screening: historisch abhängig von NSCALE_API_KEY; produktiv via DEEPSEEK_API_KEY
